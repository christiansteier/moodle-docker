...
echo "\n[i] Install Moodle\n"
cd /tmp
curl -LO https://download.moodle.org/download.php/stable${VERSION}${RELEASE}/moodle-${VERSION}.${RELEASE}.9.tgz
curl -LO https://download.moodle.org/stable${VERSION}${RELEASE}/moodle-${VERSION}.${RELEASE}.9.tgz.tgz.sha256
